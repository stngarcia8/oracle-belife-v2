...
prompt Insertando clientes de ejemplo;
		insert into belife.cliente values ('13707641-1', 'Daniel', 'Garcia Asathor', to_date('08/04/1975'), 1, 1);
		insert into belife.cliente values ('1-9', 'Daniela', 'Garcia Roman', to_date('05/03/1996'), 2, 1);
		insert into belife.cliente values ('2-8', 'Loreto', 'Roman Quiroz', to_date('29/09/1974'), 2, 1);
...
-- insertando contratos de ejemplo.
prompt Insertando contratos de ejemplo;
INSERT INTO belife.contrato VALUES ('123', sysdate, sysdate,  '13707641-1', 'VID01', sysdate, sysdate, 1, 1, 12, 1, 'Contrato de prueba para el cliente 1');
INSERT INTO belife.contrato VALUES ('321', sysdate, sysdate,  '1-9', 'VID03', sysdate, sysdate, 1, 1, 12, 1, 'Contrato de prueba para el cliente 1');
INSERT INTO belife.contrato VALUES ('123', sysdate, sysdate,  '1-9', 'VID01', sysdate, sysdate, 1, 1, 12, 1, 'Contrato de prueba para el cliente 1');
INSERT INTO belife.contrato VALUES ('456', sysdate, sysdate,  '1-9', 'VID02', sysdate, sysdate, 1, 1, 12, 1, 'Contrato de prueba para el cliente 1');
...
(select count(*) from belife.cliente) as clientes
FROM dual;
